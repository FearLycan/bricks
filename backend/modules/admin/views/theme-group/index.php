 ...
 * @var backend\modules\admin\models\ThemeGroupSearch $searchModel
 * @var yii\data\ActiveDataProvider                   $dataProvider
 */

$this->title = 'Theme Groups';
$this->params['breadcrumbs'][] = $this->title;

?>
<div class="theme-group-index">
    <div class="d-flex align-items-center gap-2 mb-3">
        <h1 class="mb-0"><?= Html::encode($this->title) ?></h1>
        <div class="ms-auto d-flex gap-2">
            <?= Html::a('Create Theme Group', ['create'], ['class' => 'btn btn-sm btn-success']) ?>
        </div>
    </div>
    ...
    <?= GridView::widget([
            ...
            'columns'      => [
                    ...
                    [
                            ...
                            'format'    => 'raw',
                            'value'     => static function (ThemeGroup $model): string {
