 ...
 * @var SetOfferImportSearch        $searchModel
    ...
    <?= GridView::widget([
            ...
            'columns'      => [
                    ...
                    [
                            ...
                            'buttons'  => [
                                    'accept' => static function (string $url, SetOfferImport $model) use ($currentReturnUrl): string {
                                        if ($model->status !== SetOfferImportStatusEnum::AWAITING_REVIEW->value) {
                                            return '';
                                        }

                                        $form = Html::beginForm(['/admin/set-offer-import/accept', 'id' => $model->id, 'returnUrl' => $currentReturnUrl], 'post', [
                                            'class' => 'd-inline',
                                        ]);
                                    ...
                                    'delete' => static function (string $url, SetOfferImport $model): string {
                                        $form = Html::beginForm(['/admin/set-offer-import/delete', 'id' => $model->id], 'post', [
                                            'class' => 'd-inline',
                                        ]);
