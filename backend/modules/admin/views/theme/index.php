 ...
 * @var backend\modules\admin\models\ThemeSearch $searchModel
...
<div class="theme-index">
    <div class="d-flex align-items-center gap-2 mb-3">
        ...
        <div class="ms-auto d-flex gap-2">
            <?= Html::a('Create Theme', ['create'], ['class' => 'btn btn-sm btn-success']) ?>
        </div>
    </div>
    ...
    <?= GridView::widget([
            ...
            'columns'      => [
                    ...
                    [
                            ...
                            'label'     => 'Group',
                            'filter'    => $groupsList,
                            'value'     => static fn(Theme $model): string => $model->group->name ?? '-',
                    ],
                    [
                            'attribute' => 'parent_id',
                            'label'     => 'Parent',
                            'filter'    => $parentsList,
                            'value'     => static fn(Theme $model): string => $model->parent->name ?? '-',
                    ],
                    [
                            'attribute' => 'status',
                            'filter'    => StatusEnum::options(),
                            'format'    => 'raw',
                            'value'     => static function (Theme $model): string {
