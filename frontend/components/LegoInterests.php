    ...
    public static function getTiles(): array
    {
        ...
        return [
            ...
            [
                'key'         => 'for-kids',
                'group'       => T::tr('By age'),
                'name'        => T::tr('For Kids (5–8)'),
                'description' => T::tr('Approachable real-brick sets for primary-school kids — finishable in one sitting.'),
                'url'         => ['/lego/for-kids'],
                'icon'        => 'bi-emoji-smile',
                'modifier'    => 'kids',
                'image'       => null,
            ...
            [
                'key'         => 'for-tweens',
                'group'       => T::tr('By age'),
                'name'        => T::tr('For Tweens (9–12)'),
                'description' => T::tr('Bigger, more detailed builds for ages 9 to 12.'),
                'url'         => ['/lego/for-tweens'],
            ...
            [
                'key'         => 'small-builds',
                'group'       => T::tr('Set type'),
                'name'        => T::tr('Small Builds'),
                'description' => T::tr('Quick builds under 200 pieces — gifts, party favours and impulse pickups.'),
                'url'         => ['/lego/small-builds'],
                'icon'        => 'bi-bricks',
            ...
            [
                'key'         => 'big-builds',
                'group'       => T::tr('Set type'),
                'name'        => T::tr('Big Builds'),
                'description' => T::tr('Multi-day, multi-thousand-piece projects for serious builders.'),
                'url'         => ['/lego/big-builds'],
                'icon'        => 'bi-building',
                'modifier'    => 'big-builds',
                'image'       => null,
