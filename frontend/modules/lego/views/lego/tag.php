...
$this->params['metaDescription'] = T::tr('Browse LEGO sets tagged "{tag}" on BrickAtlas. Compare current prices across major retailers and discover related themes and exclusive releases.', ['tag' => $tag->name]);
